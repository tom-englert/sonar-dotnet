...
namespace Microsoft.CodeAnalysis.FlowAnalysis
{
    ...
    public sealed partial class ControlFlowGraph
    {
        ...
        private readonly ImmutableDictionary<IMethodSymbol, (ControlFlowRegion, ILocalFunctionOperation, int)> _localFunctionsMap;
        private ControlFlowGraph[] _lazyLocalFunctionsGraphs;
        private readonly ImmutableDictionary<IFlowAnonymousFunctionOperation, (ControlFlowRegion, int)> _anonymousFunctionsMap;
        ...
        internal ControlFlowGraph(IOperation originalOperation,
                                  ...
                                  ImmutableDictionary<IMethodSymbol, (ControlFlowRegion, ILocalFunctionOperation, int)> localFunctionsMap,
                                  ImmutableDictionary<IFlowAnonymousFunctionOperation, (ControlFlowRegion, int)> anonymousFunctionsMap)
        {
            ...
            {
                Debug.Assert(method.MethodKind == MethodKindEx.LocalFunction);
...
#pragma warning disable RS0026 // Do not add multiple public overloads with optional parameters
        ...
        public static ControlFlowGraph Create(SyntaxNode node, SemanticModel semanticModel, CancellationToken cancellationToken = default)
        {
            ...
            IOperation operation = null; //FIXME: Convert semanticModel.GetOperation(node, cancellationToken);
...
#pragma warning restore RS0026 // Do not add multiple public overloads with optional parameters
        ...
        internal static ControlFlowGraph CreateCore(IOperation operation, string argumentNameForException, CancellationToken cancellationToken)
        {
            ...
            catch (Exception e) //FIXME: Mock when (FatalError.ReportWithoutCrashUnlessCanceled(e))
            {
        ...
        {
            if (!_localFunctionsMap.TryGetValue(localFunction, out (ControlFlowRegion, ILocalFunctionOperation, int) info))
            {
        ...
        {
            if (!_anonymousFunctionsMap.TryGetValue(anonymousFunction, out (ControlFlowRegion, int) info))
            {
                controlFlowGraph = null;
                return false;
            }
